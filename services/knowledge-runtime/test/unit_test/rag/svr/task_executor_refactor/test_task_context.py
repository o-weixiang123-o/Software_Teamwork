...
class TestTaskContextInit:
    ...
    def test_init_with_minimal_task(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1"}
...
class TestTaskContextIdentityProperties:
    ...
    def test_id(self):
        """Test id property."""
        task = {"id": "task_123", "scope_id": "scope_1"}
        ctx = _make_ctx(task=task)
    ...
    def test_kb_id(self):
        """Test kb_id property."""
        task = {"id": "task_1", "scope_id": "scope_1", "kb_id": "kb_1"}
        ctx = _make_ctx(task=task)
    ...
    def test_doc_id(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "doc_id": "doc_1"}
        ctx = _make_ctx(task=task)
    ...
    def test_doc_ids(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "doc_ids": ["doc_1", "doc_2"]}
        ctx = _make_ctx(task=task)
...
class TestTaskContextDocumentMetadataProperties:
    ...
    def test_name(self):
        """Test name property."""
        task = {"id": "task_1", "scope_id": "scope_1", "name": "test.pdf"}
        ctx = _make_ctx(task=task)
    ...
    def test_size(self):
        """Test size property."""
        task = {"id": "task_1", "scope_id": "scope_1", "size": 1024}
        ctx = _make_ctx(task=task)
...
class TestTaskContextParserProperties:
    ...
    def test_parser_id(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "parser_id": "naive"}
        ctx = _make_ctx(task=task)
    ...
    def test_parser_config(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "parser_config": {"chunk_size": 512}}
        ctx = _make_ctx(task=task)
    ...
    def test_kb_parser_config(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "kb_parser_config": {"language": "en"}}
        ctx = _make_ctx(task=task)
...
class TestTaskContextLanguageAndModelProperties:
    ...
    def test_language(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "language": "zh"}
        ctx = _make_ctx(task=task)
    ...
    def test_llm_id(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "llm_id": "gpt-4"}
        ctx = _make_ctx(task=task)
    ...
    def test_embd_id(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "embd_id": "text-embedding-ada-002"}
        ctx = _make_ctx(task=task)
...
class TestTaskContextPageRangeProperties:
    ...
    def test_from_page(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "from_page": 10}
        ctx = _make_ctx(task=task)
    ...
    def test_to_page(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "to_page": 100}
        ctx = _make_ctx(task=task)
...
class TestTaskContextTaskTypeAndRoutingProperties:
    ...
    def test_task_type(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "task_type": "raptor"}
        ctx = _make_ctx(task=task)
...
class TestTaskContextAdditionalProperties:
    ...
    def test_pagerank(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "pagerank": 10}
        ctx = _make_ctx(task=task)
    ...
    def test_file(self):
        """Test file property."""
        file_obj = MagicMock()
        task = {"id": "task_1", "scope_id": "scope_1", "file": file_obj}
        ctx = _make_ctx(task=task)
...
class TestTaskContextRawTask:
    ...
    def test_raw_task_returns_original_dict(self):
        ...
        task = {"id": "task_1", "scope_id": "scope_1", "custom_key": "value"}
        ctx = _make_ctx(task=task)
